...
quotes = quotes_historical_yahoo_ochl(
    "INTC", datetime.date(1995, 1, 1), datetime.date(2012, 1, 23))
...
for idx in xrange(lastN):
    ...
    actual_price = quotes[-lastN+idx+1][2]
...
ax2.plot(predicted_prices)
ax2.plot(actual_prices)
plt.show()